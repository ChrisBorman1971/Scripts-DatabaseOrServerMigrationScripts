...
If Exists(Select * from sysobjects where name = 'usp_CreateSQLServerUserRoles')
	Drop Procedure dbo.usp_CreateSQLServerUserRoles
...
Exec [dbo].[usp_CreateSQLServerUserRoles]
go
